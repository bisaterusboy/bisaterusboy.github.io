        ...
        <div className="container">
          <div className="row gy-4">
            ...
            <div className="col-lg-4 col-md-12">
              <div className="py-5 h-100 d-flex flex-column justify-content-between">
                <h4 className="mb-3" style={{ color: "var(--text-primary)", letterSpacing: "1px" }}>
                  <span style={{ verticalAlign: "middle", marginRight: "8px" }}>📧</span>Our Newsletter
                </h4>
                <p className="mb-3" style={{ color: "var(--text-light)", fontSize: "1.08rem" }}>
                  Subscribe to our newsletter and receive the latest news about our products and services!
                </p>
                <form className="d-flex gap-2 align-items-center" autoComplete="off">
