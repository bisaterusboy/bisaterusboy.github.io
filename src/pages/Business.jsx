        ...
        <section id="contact" className="section-padding" style={{ backgroundColor: 'var(--bg-secondary)' }}>
            <div className="container">
                <div className="text-center mb-5">
                    ...
                    <p className="section-subtitle" style={{ color: 'var(--text-secondary)' }}> <a href="/">Home</a> / Layanan Internet</p>
                </div>
                    ...
                    <div className="col-md-12 mt-2">
                        <div className="row">
                            <div className="col-md-12">
                                ...
                                <img src="../assets/img/internet1.png" class="card-img-top rounded-5 shadow" alt="..."></img>
